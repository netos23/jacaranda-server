...
public class HttpResponse {
	...
	public class HttpResponseBuilder {
		...
		public HttpResponse build() throws HttpResponseBuildException {
			validateHttpResponse();
			return HttpResponse.this;
		}

		private void validateHttpResponse() throws HttpResponseBuildException {
			if(status == null || httpVersion == null || httpVersion.isEmpty()){
				throw new HttpResponseBuildException("One or more required fields missing");
			}
		}
