...
public class HttpRequest {
	...
	public static HttpRequest parse(InputStream is, ServerConfiguration context) throws HttpRequestBuildException {
		return parse(new InputReader(is), context);
	}

	public static HttpRequest parse(String request, ServerConfiguration context) throws HttpRequestBuildException {
		return parse(new InputReader(request), context);
	}

	private static HttpRequest parse(InputReader sc, ServerConfiguration context) throws HttpRequestBuildException {
		try {
			// read method
